...
export default function NavBar() {
  ...
  return (
    <>
      <p class="flex h-10 items-center justify-center bg-gray-800 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
        Llámanos! +52 (33) 3628-3660 | Envíos sin costo en compras mayores a
        $2,000 MXN | ventas1@icb-mx.com
      </p>
